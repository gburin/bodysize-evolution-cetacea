...
here::i_am("R/bayou_analyses/noextant_wZBL/bayou_noextant_wZBL_k5.R")
...
priorOU.noextant.wZBL.k5 <- make.prior(slater.tree.imput, 
...
#startpars.noextant.wZBL.k5 <- priorSim(priorOU.noextant.wZBL.k5, slater.tree.imput, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Full tree

mcmcOU.noextant.wZBL.k5 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noextant.wZBL.k5, file.dir = here::here("output/bayou/noextant_wZBL/bayou_noextant_wZBL_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noextant.wZBL.k5$run(1000000) # Run the MCMC
