...
here::i_am("R/bayou_analyses/noextant_wZBL/bayou_noextant_wZBL_k500.R")
...
priorOU.noextant.wZBL.k500 <- make.prior(slater.tree.imput, 
...
mcmcOU.noextant.wZBL.k500 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noextant.wZBL.k500, file.dir = here::here("output/bayou/noextant_wZBL/bayou_noextant_wZBL_k500_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noextant.wZBL.k500$run(1000000) # Run the MCMC
