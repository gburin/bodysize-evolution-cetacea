...
here::i_am("R/bayou_analyses/baleen/bayou_baleen_k5.R")
...
priorOU.baleen.k5 <- make.prior(baleen.tree, 
...
mcmcOU.baleen.k5 <- bayou.makeMCMC(baleen.tree, tl.bayou, SE = se.bayou, prior = priorOU.baleen.k5, file.dir = here::here("output/bayou/baleen/bayou_baleen_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.baleen.k5$run(1000000) # Run the MCMC
