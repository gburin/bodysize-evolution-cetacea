...
here::i_am("R/bayou_analyses/baleen/bayou_baleen_k50.R")
...
priorOU.baleen.k50 <- make.prior(baleen.tree, 
...
mcmcOU.baleen.k50 <- bayou.makeMCMC(baleen.tree, tl.bayou, SE = se.bayou, prior = priorOU.baleen.k50, file.dir = here::here("output/bayou/baleen/bayou_baleen_k50_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.baleen.k50$run(1000000) # Run the MCMC
