...
here::i_am("R/bayou_analyses/baleen/bayou_baleen_k15.R")
...
priorOU.baleen.k15 <- make.prior(baleen.tree, 
...
mcmcOU.baleen.k15 <- bayou.makeMCMC(baleen.tree, tl.bayou, SE = se.bayou, prior = priorOU.baleen.k15, file.dir = here::here("output/bayou/baleen/bayou_baleen_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.baleen.k15$run(1000000) # Run the MCMC
