...
here::i_am("R/bayou_analyses/noarchaeo_wZBL/bayou_noarchaeo_wZBL_k5.R")
...
priorOU.noarchaeo.wZBL.k5 <- make.prior(slater.tree.noarchaeo, 
...
mcmcOU.noarchaeo.wZBL.k5 <- bayou.makeMCMC(slater.tree.noarchaeo, tl.bayou, SE = se.bayou, prior = priorOU.noarchaeo.wZBL.k5, file.dir = here::here("output/bayou/noarchaeo_wZBL/bayou_noarchaeo_wZBL_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noarchaeo.wZBL.k5$run(1000000) # Run the MCMC
