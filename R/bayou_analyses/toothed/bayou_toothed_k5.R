...
here::i_am("R/bayou_analyses/toothed/bayou_toothed_k5.R")
...
priorOU.toothed.k5 <- make.prior(toothed.tree, 
...
mcmcOU.toothed.k5 <- bayou.makeMCMC(toothed.tree, tl.bayou, SE = se.bayou, prior = priorOU.toothed.k5, file.dir = here::here("output/bayou/toothed/bayou_toothed_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.toothed.k5$run(1000000) # Run the MCMC
