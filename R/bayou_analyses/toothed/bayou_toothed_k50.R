...
here::i_am("R/bayou_analyses/toothed/bayou_toothed_k50.R")
...
priorOU.toothed.k50 <- make.prior(toothed.tree, 
...
mcmcOU.toothed.k50 <- bayou.makeMCMC(toothed.tree, tl.bayou, SE = se.bayou, prior = priorOU.toothed.k50, file.dir = here::here("output/bayou/toothed/bayou_toothed_k50_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.toothed.k50$run(1000000) # Run the MCMC
