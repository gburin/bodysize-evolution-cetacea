...
here::i_am("R/bayou_analyses/toothed/bayou_toothed_k15.R")
...
priorOU.toothed.k15 <- make.prior(toothed.tree, 
...
mcmcOU.toothed.k15 <- bayou.makeMCMC(toothed.tree, tl.bayou, SE = se.bayou, prior = priorOU.toothed.k15, file.dir = here::here("output/bayou/toothed/bayou_toothed_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.toothed.k15$run(1000000) # Run the MCMC
