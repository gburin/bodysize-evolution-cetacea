...
here::i_am("R/bayou_analyses/noimput/bayou_noimput_k50.R")
...
priorOU.noimput.k50 <- make.prior(slater.tree.imput, 
...
## startpars.noimput.k50 <- priorSim(priorOU.noimput.k50, slater.tree.imput, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Noimput tree

mcmcOU.noimput.k50 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noimput.k50, file.dir = here::here("output/bayou/noimput/bayou_noimput_k50_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noimput.k50$run(1000000) # Run the MCMC
