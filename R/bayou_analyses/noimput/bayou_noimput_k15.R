...
here::i_am("R/bayou_analyses/noimput/bayou_noimput_k15.R")
...
priorOU.noimput.k15 <- make.prior(slater.tree.imput, 
...
## startpars.noimput.k15 <- priorSim(priorOU.noimput.k15, slater.tree.imput, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Noimput tree

mcmcOU.noimput.k15 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noimput.k15, file.dir = here::here("output/bayou/noimput/bayou_noimput_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noimput.k15$run(1000000) # Run the MCMC
