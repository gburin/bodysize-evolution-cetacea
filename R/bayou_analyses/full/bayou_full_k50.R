...
here::i_am("R/bayou_analyses/full/bayou_full_k50.R")
...
priorOU.full.k50 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.k50 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.k50, file.dir = here::here("output/bayou/full/bayou_full_k50_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.k50$run(1000000) # Run the MCMC
