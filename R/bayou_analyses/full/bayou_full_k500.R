...
here::i_am("R/bayou_analyses/full/bayou_full_k500.R")
...
priorOU.full.k500 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.k500 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.k500, file.dir = here::here("output/bayou/full/bayou_full_k500_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.k500$run(1000000) # Run the MCMC
