...
here::i_am("R/bayou_analyses/full/bayou_full_k5.R")
...
priorOU.full.k5 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.k5 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.k5, file.dir = here::here("output/bayou/full/bayou_full_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.k5$run(1000000) # Run the MCMC
