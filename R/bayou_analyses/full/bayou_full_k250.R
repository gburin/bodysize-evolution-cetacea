...
here::i_am("R/bayou_analyses/full/bayou_full_k250.R")
...
priorOU.full.k250 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.k250 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.k250, file.dir = here::here("output/bayou/full/bayou_full_k250_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.k250$run(1000000) # Run the MCMC
