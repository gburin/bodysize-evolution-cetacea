...
here::i_am("R/bayou_analyses/full/bayou_full_k15.R")
...
priorOU.full.k15 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.k15 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.k15, file.dir = here::here("output/bayou/full/bayou_full_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.k15$run(1000000) # Run the MCMC
