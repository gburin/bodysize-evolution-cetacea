...
here::i_am("R/bayou_analyses/noarchaeo/bayou_noarchaeo_k250.R")
...
priorOU.noarchaeo.k250 <- make.prior(slater.tree.noarchaeo, 
...
## startpars.noarchaeo.k250 <- priorSim(priorOU.noarchaeo.k250, slater.tree.noarchaeo, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Full tree

mcmcOU.noarchaeo.k250 <- bayou.makeMCMC(slater.tree.noarchaeo, tl.bayou, SE = se.bayou, prior = priorOU.noarchaeo.k250, file.dir = here::here("output/bayou/noarchaeo/bayou_noarchaeo_k250_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noarchaeo.k250$run(1000000) # Run the MCMC
