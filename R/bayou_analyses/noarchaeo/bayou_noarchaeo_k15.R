...
here::i_am("R/bayou_analyses/noarchaeo/bayou_noarchaeo_k15.R")
...
priorOU.noarchaeo.k15 <- make.prior(slater.tree.noarchaeo, 
...
## startpars.noarchaeo.k15 <- priorSim(priorOU.noarchaeo.k15, slater.tree.noarchaeo, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Full tree

mcmcOU.noarchaeo.k15 <- bayou.makeMCMC(slater.tree.noarchaeo, tl.bayou, SE = se.bayou, prior = priorOU.noarchaeo.k15, file.dir = here::here("output/bayou/noarchaeo/bayou_noarchaeo_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noarchaeo.k15$run(1000000) # Run the MCMC
