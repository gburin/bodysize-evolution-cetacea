...
here::i_am("R/bayou_analyses/noarchaeo/bayou_noarchaeo_k500.R")
...
priorOU.noarchaeo.k500 <- make.prior(slater.tree.noarchaeo, 
...
## startpars.noarchaeo.k500 <- priorSim(priorOU.noarchaeo.k500, slater.tree.noarchaeo, plot = FALSE)$pars[[1]]


## Setting up and running MCMC - Full tree

mcmcOU.noarchaeo.k500 <- bayou.makeMCMC(slater.tree.noarchaeo, tl.bayou, SE = se.bayou, prior = priorOU.noarchaeo.k500, file.dir = here::here("output/bayou/noarchaeo/bayou_noarchaeo_k500_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noarchaeo.k500$run(1000000) # Run the MCMC
