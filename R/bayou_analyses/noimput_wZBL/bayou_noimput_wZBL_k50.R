...
here::i_am("R/bayou_analyses/noimput_wZBL/bayou_noimput_wZBL_k50.R")
...
priorOU.noimput.wZBL.k50 <- make.prior(slater.tree.imput, 
...
mcmcOU.noimput.wZBL.k50 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noimput.wZBL.k50, file.dir = here::here("output/bayou/noimput_wZBL/bayou_noimput_wZBL_k50_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noimput.wZBL.k50$run(1000000) # Run the MCMC
