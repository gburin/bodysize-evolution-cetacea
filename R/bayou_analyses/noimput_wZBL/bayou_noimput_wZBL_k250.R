...
here::i_am("R/bayou_analyses/noimput_wZBL/bayou_noimput_wZBL_k250.R")
...
priorOU.noimput.wZBL.k250 <- make.prior(slater.tree.imput, 
...
mcmcOU.noimput.wZBL.k250 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noimput.wZBL.k250, file.dir = here::here("output/bayou/noimput_wZBL/bayou_noimput_wZBL_k250_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noimput.wZBL.k250$run(1000000) # Run the MCMC
