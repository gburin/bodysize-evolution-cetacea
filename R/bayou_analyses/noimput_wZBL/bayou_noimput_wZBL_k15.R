...
here::i_am("R/bayou_analyses/noimput_wZBL/bayou_noimput_wZBL_k15.R")
...
priorOU.noimput.wZBL.k15 <- make.prior(slater.tree.imput, 
...
mcmcOU.noimput.wZBL.k15 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.noimput.wZBL.k15, file.dir = here::here("output/bayou/noimput_wZBL/bayou_noimput_wZBL_k15_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.noimput.wZBL.k15$run(1000000) # Run the MCMC
