...
here::i_am("R/bayou_analyses/full_wZBL/bayou_full_wZBL_k5.R")
...
priorOU.full.wZBL.k5 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.wZBL.k5 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.wZBL.k5, file.dir = here::here("output/bayou/full_wZBL/bayou_full_wZBL_k5_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.wZBL.k5$run(1000000) # Run the MCMC
