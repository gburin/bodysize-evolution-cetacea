...
here::i_am("R/bayou_analyses/full_wZBL/bayou_full_wZBL_k500.R")
...
priorOU.full.wZBL.k500 <- make.prior(slater.tree.imput, 
...
mcmcOU.full.wZBL.k500 <- bayou.makeMCMC(slater.tree.imput, tl.bayou, SE = se.bayou, prior = priorOU.full.wZBL.k500, file.dir = here::here("output/bayou/full_wZBL/bayou_full_wZBL_k500_fixedSE"), outname = "modelOU_imput_r001", plot.freq = NULL, samp = 1000) # Set up the MCMC

## mcmcOU.full.wZBL.k500$run(1000000) # Run the MCMC
